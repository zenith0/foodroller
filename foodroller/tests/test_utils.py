...
class FoodUtilsTestCase(TestCase):
    def setUp(self):
        ...
        food_29 = Food.objects.create(name="30 min", duration="30min")
        food_29.categories.add(category)
        food_29.save()
        food_59 = Food.objects.create(name="1 hr", duration="1hr")
        food_59.categories.add(category)
        food_59.save()
        food_119 = Food.objects.create(name="2 hr", duration="2hr")
        food_119.categories.add(category)
        food_119.save()
        food_121 = Food.objects.create(name="3 hr", duration="2hr+")
    ...
    def test_filter_food_by_duration(self):
        ...
        res_list = filter_food_by_duration(food_list, "30min")
        ...
        res_list = filter_food_by_duration(food_list, "1hr")
        self.assertTrue(food_29 in res_list)
        self.assertTrue(food_59 in res_list)
        self.assertFalse(food_119 in res_list)
        self.assertFalse(food_121 in res_list)

        res_list = filter_food_by_duration(food_list, "2hr")
        self.assertTrue(food_29 in res_list)
        self.assertTrue(food_59 in res_list)
